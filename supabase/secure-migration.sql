...
begin
  ...
  insert into public.orders (id, school, outlet_name, outlet_address, outlet_phone, customer_surname, customer_phone_last4, exchange_source_receipt_id, cashier_id, cashier_name, total, item_count, created_at)
  values (
    receipt_id,
